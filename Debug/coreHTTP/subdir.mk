...
C_SRCS += \
../coreHTTP/core_http_client.c 

OBJS += \
./coreHTTP/core_http_client.o 

C_DEPS += \
./coreHTTP/core_http_client.d 


# Each subdirectory must supply rules for building sources it contributes
coreHTTP/%.o coreHTTP/%.su coreHTTP/%.cyclo: ../coreHTTP/%.c coreHTTP/subdir.mk
...
clean: clean-coreHTTP

clean-coreHTTP:
	-$(RM) ./coreHTTP/core_http_client.cyclo ./coreHTTP/core_http_client.d ./coreHTTP/core_http_client.o ./coreHTTP/core_http_client.su

.PHONY: clean-coreHTTP
