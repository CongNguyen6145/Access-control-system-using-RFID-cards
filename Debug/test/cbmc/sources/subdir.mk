...
OBJS += \
./test/cbmc/sources/http_cbmc_state.o 

C_DEPS += \
./test/cbmc/sources/http_cbmc_state.d 


# Each subdirectory must supply rules for building sources it contributes
test/cbmc/sources/%.o test/cbmc/sources/%.su test/cbmc/sources/%.cyclo: ../test/cbmc/sources/%.c test/cbmc/sources/subdir.mk
...
clean: clean-test-2f-cbmc-2f-sources

clean-test-2f-cbmc-2f-sources:
	-$(RM) ./test/cbmc/sources/http_cbmc_state.cyclo ./test/cbmc/sources/http_cbmc_state.d ./test/cbmc/sources/http_cbmc_state.o ./test/cbmc/sources/http_cbmc_state.su

.PHONY: clean-test-2f-cbmc-2f-sources
